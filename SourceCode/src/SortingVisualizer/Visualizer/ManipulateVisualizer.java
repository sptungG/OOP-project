...
import SortingVisualizer.Data.Helpers;
import SortingVisualizer.Data.ValidateData;
...
public class ManipulateVisualizer {
    ...
    private int curAlg = 0; // 0 for bubble, 1 for quick, 2 for insertion
    private String[] sortingProcessListMsg = {"Bubble sort", "Quick sort", "Insertion sort"};
    private String sortingProcessMsg = sortingProcessListMsg[curAlg];

    private final String ABOUT_MESSAGE = "Sorting Visualizer\n\n"
            + "This program is built to help you visualize some of sorting alogirthms namely: Bubble sort, Quick sort, Insertion sort.\n\n"
            + "We will keep developing with another algorithms in the future.\n\n"
            + "Thank you for using our program \u2665\n\n"
            + "(c) Copyright by OOLT.ICT.20202.Team10";
    private final String HELP_INSTRUCTION_MESSAGE = "Here is the instruction of program:\n"
            ...
            + "- Random: You should input an postive integer for array length.\n"
            + "- Manual: You should input an postive integer array.\n"
            ...
            + "You can refer to this demo video:\n"
            + "https://husteduvn-my.sharepoint.com/:v:/g/personal/thang_ph184305_sis_hust_edu_vn/EZ_l7h_diz1GpxCKLJRAbDsBzTZoBceJrfDMlTtpmzmoUA?e=sbFKDy";

    private static final int MAX_ARRAY_LENGTH = 300;//bien hang

    private String displayTextArea = "[\n \n]";

    // GRAPH VARIABLES
    private static final int GRAPH_SIZE = 600;//bien hang
    ...
    private String[] algorithmOptions = {"Bubble sort", "Quick sort", "Insertion sort"};
    ...
    public JLabel arrayAccessedLabel = new JLabel("Array Accessd: " + arrayAccessed);
